...
const num = formatCur(balance, acc.locale, acc.currency);
...
btnTransfer.addEventListener("click", function(e){
 ...
 const currentBalance = calcDisplayBalance(currentAccount);
